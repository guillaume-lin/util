...
/* package haskell-util-0.1.0.0 */
#ifndef VERSION_haskell_util
#define VERSION_haskell_util "0.1.0.0"
#endif /* VERSION_haskell_util */
#ifndef MIN_VERSION_haskell_util
#define MIN_VERSION_haskell_util(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_haskell_util */
...
#define CURRENT_COMPONENT_ID "haskell-util-0.1.0.0-inplace-haskell-util"
